...
//    UNSUPPORTED_TOKEN("UNSUPPORTED_TOKEN", "지원하지 않는 토큰");
    ...
    UNKNOWN_ERROR("7001", "UNKNOWN_ERROR"),
    NOT_FOUND_TOKEN("7002", "Headers에 토큰 형식의 값 찾을 수 없음"),
    INVALID_TOKEN("7003", "유효하지 않은 토큰"),
    EXPIRED_TOKEN("7004", "기간이 만료된 토큰"),
    UNSUPPORTED_TOKEN("7005", "지원하지 않는 토큰");
    @Getter
